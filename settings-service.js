...
const SETTINGS_DEFINITIONS = {
  ...
  cloudflare_api_token:  { envVar: 'CLOUDFLARE_API_TOKEN',  default: '', type: 'string',  category: 'integrations', label: 'Cloudflare API Token',       sensitive: true,  description: 'API token with Zone:Read and DNS:Read permissions. Optionally add Account:Cloudflare Tunnel:Read for tunnel health monitoring.' },
  cloudflare_account_id: { envVar: 'CLOUDFLARE_ACCOUNT_ID', default: '', type: 'string',  category: 'integrations', label: 'Cloudflare Account ID',     sensitive: false, description: 'Account ID for Cloudflare Tunnel status checks. Found on the Cloudflare dashboard overview page.' },
  cloudflare_tunnel_check_enabled: { envVar: null, default: 'true', type: 'boolean', category: 'integrations', label: 'Enable Tunnel Health Checks', sensitive: false, description: 'Automatically detect and monitor Cloudflare Tunnels from CNAME records pointing to *.cfargotunnel.com.' },
